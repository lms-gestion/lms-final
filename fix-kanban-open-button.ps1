  ...
  return (
    <div className="flex-1 overflow-y-auto p-6">
      ...
      <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <div className="text-sm text-slate-500">{filteredChantiers.length} chantier(s)</div>
      </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <label className="space-y-1">
                  ...
                  <select
                    value={form.priority}
                    onChange={(e) =>
                      setField('priority', e.target.value as 'normal' | 'haute' | 'urgence')
                    }
                    className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm"
                  >
                    ...
                    cards.map((chantier) => (
                      ...
                      >
                        <div className="mb-3 flex items-start justify-between gap-2">
                          ...
                          <span
                            className={
                              ...
                              priorityClass(chantier.priority)
                            }
                          >
                            {chantier.priority}
                          </span>
                        ...
                        {chantier.description && (
                          <p className="mt-3 text-sm text-slate-500">{chantier.description}</p>
                        )}
                        ...
                        <div className="mt-4 grid grid-cols-4 gap-2">
                          ...
                          <Link
                            ...
                            className="rounded-lg border border-orange-200 bg-orange-50 px-2 py-1 text-center text-xs font-semibold text-orange-700 hover:bg-orange-100"
                          >
                            Ouvrir
                          </Link>
